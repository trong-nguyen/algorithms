...
def test_rotate_right():
    ...
    assert nodes[2].left == nodes[4] and nodes[4].parent == nodes[2]
...
def test_red_black_tree():
    ...
    left_tree.assert_equal_black_height()
    print left_tree
...
def test_red_black_height():
    print 'Testing black height equalities for varying tree sizes ...'
